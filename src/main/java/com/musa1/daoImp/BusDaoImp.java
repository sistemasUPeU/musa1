...
public class BusDaoImp implements BusDao{
	...
	public int update(Bus b) {
		...
		return jdbcTemplate.update("call pkg_crud_bus.sp_update_bus(?,?,?,?,?,?,?,?,?,?)",b.getId_bus(),b.getMarca(),b.getPlaca(),b.getDescripcion(),b.getEstado(),b.getModelo(),b.getNro_motor(),b.getAño_fabricacion(),b.getNro_serie(),b.getNro_asientos());
